...
public class ContainerPBImpl extends Container {
  ...
  private static final Log LOG = LogFactory.getLog(ContainerPBImpl.class);
  ...
  public String getNodeHttpAddress() {
    ...
    //modify by dongping 20190322 end
    String nodeHttpAddress = (p.getNodeHttpAddress());
    LOG.debug("nodeHttpAddress: " + nodeHttpAddress);
